...
import zeroneye.countdown.item.ItemGroups;
...
public class IBlocks {
    ...
    static {
        ...
        SLOW_DOWN = register("slow_down", new TimeBlock(Block.Properties.create(Material.CARPET).lightValue(1).doesNotBlockMovement(), 0xffd500));
        PAUSE = register("pause", new TimeBlock(Block.Properties.create(Material.CARPET).lightValue(1).doesNotBlockMovement(), 0xff9500));
    }
